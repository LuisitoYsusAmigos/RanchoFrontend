...
window.onload = async function () {
    try {
        ...
        const loadData = async () => {
            try {
                const response = await fetch(`https://ranchoback.api.dev.dtt.tja.ucb.edu.bo/lectura/lecturasCatastroNoPagado/${id_catastro}`);
        ...
        document.getElementById('crearRecibo').addEventListener('click', async function () {
            ...
            const maxReciboId = await (await fetch("https://ranchoback.api.dev.dtt.tja.ucb.edu.bo/recibo/obtenerReciboIdMax")).json();
            ...
            fetch("https://ranchoback.api.dev.dtt.tja.ucb.edu.bo/recibo/create", {
                method: "POST",
                headers: {
                ...
                .then(data => {
                    ...
                    for (const id of idsLectura) {
                        ...
                        fetch("https://ranchoback.api.dev.dtt.tja.ucb.edu.bo/lecturaRecibo/create", {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json"
                            },
